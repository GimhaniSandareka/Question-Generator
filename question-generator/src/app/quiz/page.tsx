...
import QuizSubmission from "@/quiz/QuizSubmission";
...
const questions = [
    {
        ...
        answers: [
            {
                answerText: "A library for building user interface",
                isCorrect: true,
                id: 1
            },
            {
                                ...
                                questions[currentQuestion].answers.map(answer => {
                                    ...
                                    return (
                                        <Button key={answer.id} variant={variant} size="xl"
                                                onClick={() => handleAnswer(answer)}><p>{answer.answerText}</p></Button>
                                    )
                                })
                            }
                        </div>
